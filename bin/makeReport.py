...
df = pangolinTyping.merge(
    nextclade, on="sample name", how="left", suffixes=("_pango", "_nextclade")
)
...
df["taxon"] = df["taxon"].replace(
    regex=True,
    to_replace="_subsample.primertrimmed.consensus_threshold_0.75_quality_20",
    value="",
)
