...
nextflow run main.nf -profile docker --illumina --prefix "ena" --directory $INPUT --schemeRepoURL "--recurse-submodules https://github.com/artic-network/artic-ncov2019"
